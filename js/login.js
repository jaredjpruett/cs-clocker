function switchLogin(view)
{
	...
	var body = "<div class='page-header'><h2 style='text-align:center'>" + header + "<br>" +
		"<small>Texas State University Department of Computer Science</small></h2></div>" +
		...
		"<div style='margin: 0 auto; text-align: center'><a class='switch' href='#' onclick='return switchLogin(" + view + ");'>" + form + "</a></div>";
